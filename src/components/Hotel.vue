<template lang="html">
  <section class="mw9 bg-white pa2 pa3-ns mr4-ns mv0 mv4-ns">
    <article class="ui three column grid">
      <div class="hotel row" v-for="(hotel, index) of filteredHotels" :key="index">
        ...
        <div class="four wide column bl  b--light-gray tc">
          <span class="f6">Precio por noche por habitación</span>
          <h4 class="f3 orange">ARS <strong class="f2 dib v-mid">{{ hotel.price }}</strong></h4>
          <a class="f6 f4-ns link dim br2 ph4 pv2 mb2 dib white bg-dark-blue" href="#">Ver hotel</a>
        </div>
      </div>
    </article>
  </section>
